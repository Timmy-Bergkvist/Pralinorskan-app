"""
Django settings for pralinorskan_app project.
...
ALLOWED_HOSTS = ['pralinorskan-app.herokuapp.com', 'localhost', '127.0.0.1']
...
if 'DEVELOPMENT' in os.environ:
    ...
    DEFAULT_FROM_EMAIL = 'pralinorskan@example.com'
else:
